...
/**
 * OVERVIEW lamp panel — top-left HUD of Niumination Mission Control.
 * Glowing filament line + sliding node + "OVERVIEW" label,
 * live clock/date and weather (open-meteo).
 *
 * Clicking the lamp opens the tiles.
 */
...
// Social links — replace with your own Niumination profiles
const TILES: Tile[] = [
  { key: "github",    icon: Sparkles, label: "Niumination GitHub",    href: "https://github.com/Niumination" },
  { key: "website",   icon: Sparkles, label: "Niumination Website",   href: "https://niumination.web.id" },
  { key: "docs",      icon: Sparkles, label: "Mission Control Docs",  href: "/docs" },
];
...
export default function ApexOverviewPanel() {
  ...
  const inner = (Icon: typeof Sparkles, label: string) => (
    <>
