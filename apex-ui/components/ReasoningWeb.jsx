...
// Niumination swarm — 5 agents (Chief + 4 specialists) around the core
const ROSTER = [
  ['chief',      'Hermes Chief', 'consultant', 340, 240, true, 18, 12],
  ['research',   'Research',     'consultant', 225, 165, true, 24, 9],
  ['programmer', 'Programmer',   'doer',       455, 170, true, -24, 9],
  ['qa',         'QA Tester',    'doer',       300, 335, true, 22, 8],
  ['creator',    'Kreator',      'doer',       445, 325, true, -20, 8],
]
