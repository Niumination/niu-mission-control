...
AGENT_CONFIG = {
    ...
    "research": {"name": "Research Agent", "model": "gemini/gemma-4-26b", "role": "researcher"},
    "programmer": {"name": "Programmer Agent", "model": "cf/deepseek-r1", "role": "developer"},
    "qa": {"name": "QA Agent", "model": "cf/zai-org/glm-4.5-air", "role": "tester"},
    "creator": {"name": "Creator Agent", "model": "gemini/gemma-4-26b", "role": "content creator"},
}
    ...
    try:
        ...
        for t in tasks:
            ...
            if agent not in agent_tasks:
                agent_tasks[agent] = {"total": 0, "running": 0, "completed": 0, "failed": 0}
        ...
        for agent_id, config in AGENT_CONFIG.items():
            stats = agent_tasks.get(agent_id, {"total": 0, "running": 0, "completed": 0, "failed": 0})
            result.append({
                "id": agent_id,
                "name": config["name"],
                "model": config["model"],
